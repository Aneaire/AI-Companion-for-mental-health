...
export function ThreadSettingsDialog({
  ...
  const { 
    getThreadConversationPreferences, 
    setThreadConversationPreferences,
    conversationPreferences: globalPreferences 
  } = useChatStore();
  
  // Get thread-specific preferences for conversation settings
  const threadPreferences = selectedThreadId 
    ? { ...globalPreferences, ...getThreadConversationPreferences(selectedThreadId) }
    : preferences;
  ...
  const updatePreference = (
    ...
    if (context === "impersonate" && selectedThreadId) {
      // For conversation tab in impersonate context, update thread-specific preferences
      const currentThreadPrefs = getThreadConversationPreferences(selectedThreadId);
      setThreadConversationPreferences(selectedThreadId, {
        ...currentThreadPrefs,
        [key]: value,
      });
    } else {
      // For main context or when no thread selected, update global preferences
      onPreferencesChange({
        ...preferences,
        [key]: value,
      });
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto sm:max-w-2xl max-w-[calc(100vw-2rem)]">
        <DialogHeader>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                 ...
                 <Switch
                   checked={currentPreferences.empatheticAndSupportive}
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                 ...
                 <Switch
                   checked={currentPreferences.solutionFocused}
                   onCheckedChange={(checked) =>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                 ...
                 <Switch
                   checked={currentPreferences.casualAndFriendly}
                   onCheckedChange={(checked) =>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                 ...
                 <Switch
                   checked={currentPreferences.professionalAndFormal}
                   onCheckedChange={(checked) =>
          ...
          <TabsContent value="voice" className="space-y-6 mt-6">
            <div>
              <h3 className="text-lg font-semibold mb-4">
                ...
                {context === "impersonate" && selectedThreadId && (
                  ...
                  <Switch
                    checked={
                      context === "main"
                        ...
                        : (currentPreferences.enableTTS ?? false)
                    }
                    onCheckedChange={(checked) =>
                    ...
                    <>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                          ...
                          <Select
                            value={currentPreferences.therapistVoiceId || ""}
                            onValueChange={(value) =>
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            value={currentPreferences.impostorVoiceId || ""}
                            onValueChange={(value) =>
                  ...
                  <Switch
                    checked={
                      context === "main"
                        ...
                        : (currentPreferences.ttsAutoPlay ?? false)
                    }
                    onCheckedChange={(checked) =>
                      updateVoicePreference(
